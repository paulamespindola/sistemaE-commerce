public class App {
    public static void main(String[] args) throws Exception {
        ...
        Produto produto4 = new Produto("Cama Box Colchão + Base Attractive Casal - Umaflex", 0004, "Móveis", 999.90, "Colchão Casal Umaflex de Mola Ensacada\r\n" + //
