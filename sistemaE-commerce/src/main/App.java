...
public class App {
    public static void main(String[] args) {
        // Inicializar a interface gráfica no Event Dispatch Thread (EDT)
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    // Inicializar a classe de interação
